...
* @brief Command console library provides a framework to add command console support to your application (or) product usecases.
...
#define CY_RSLT_COMMAND_CONSOLE_ERR_BASE                    CY_RSLT_TYPE_ERROR

#define CY_RSLT_COMMAND_CONSOLE_FAILURE                     CY_RSLT_COMMAND_CONSOLE_ERR_BASE /**< Generic Failure */
