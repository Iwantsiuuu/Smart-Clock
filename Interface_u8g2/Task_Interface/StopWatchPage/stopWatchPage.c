...
void init_stopWatch_disp(){
	...
	button.attachPressed(&btn_obj[0],startSW_Cb);
	button.attachPressed(&btn_obj[1],pauseSW_Cb);
	button.attachPressed(&btn_obj[2],resetSW_Cb);
	button.attachPressed(&btn_obj[3],BackSW_Cb);
