...
int main(void)
{
    ...
    __enable_irq();
	result = cyhal_gpio_init(P7_1, CYHAL_GPIO_DIR_OUTPUT, CYHAL_GPIO_DRIVE_OPENDRAINDRIVESHIGH, CYBSP_LED_STATE_ON);
	if(result == CY_RSLT_SUCCESS)
    ...
    printf("\r\nAwaiting voice input trigger command (\"Hello box\"):\r\n");
